...
// die();
 ...
 // $this->getShiftCommand();
	...
	function js_decrypt(){
		// $encrypted = $this->encrypt->encode('test');
		// echo $encrypted;

		$encrypted = base64_encode('MX00002');
		echo $encrypted;
		// encrypt: btoa(decodedStringBtoA);
		echo '<script type="text/javascript">';
		echo "// decryp
			var decodedStringAtoB = atob('".$encrypted."');
			console.log(decodedStringAtoB); // 'my message'";

		echo '</script>';
	}

	function decode(){
		echo base64_decode('dXNlcl9pZCx1c2VybmFtZSxwYXNzd29yZCxhY2Nlc3NfbGV2ZWw=');
		echo '<br />';
		echo base64_decode('MSxhZG1pbiw1ZjRkY2MzYjVhYTc2NWQ2MWQ4MzI3ZGViODgyY2Y5OSxBZG1pbmlzdHJhdG9yIA==');
	}
