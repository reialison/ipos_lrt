...
class TsplPrinter
{
    ...
    private $sizeWidth = 50; // paper width
    private $sizeHeight = 30; // paper height
    private $sizeUnit="mm";

    private $gapDistance = "5"; // gap distance between 2 papers
    private $gapOffset;
    private $gapUnit;
    ...
    private $direction = 0; // for direction 0 -upright or 1-downright print direction
