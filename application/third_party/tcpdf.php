...
class TCPDF {
	...
	public function Header() {
		if ($this->header_xobjid === false) {
			...
			// header title
			$this->SetFont($headerfont[0], 'R', $headerfont[2] + 1);			
			$this->SetX($header_x);
			$this->Cell($cw, $cell_height, $headerdata['title'], 0, 1, 'C', 0, '', 0);
			// header string
			$this->SetFont($headerfont[0], $headerfont[1], $headerfont[2]);
			$this->SetX($header_x);
			// $this->MultiCell($cw, $cell_height, $headerdata['string'], 0, 'C', 0, 1, '', '', true, 1, false, true, 0, 'T', false);						
			$this->MultiCell($cw, $cell_height, $headerdata['string'], 0, 'C', 0, 0, '', '', true);
