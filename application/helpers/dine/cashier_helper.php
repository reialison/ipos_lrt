...
function indexPage($needEod=false,$set,$today=null){
	$CI =& get_instance();
	$user = $CI->session->userdata('user');
		$CI->make->sDiv(array('id'=>'cashier-panel','class'=>'media-cashier-panel'));
			$CI->make->sDivRow(array('class'=>'cpanel-top'));
				$CI->make->sDivCol(7,'left',0,array('class'=>'cpanel-left media-cpanel-left-cashier','style'=>'margin:0px;'));
					$CI->make->sDivRow(array('id'=>'notif-div','style'=>'height:54px;background-color:red;margin-right:4px;margin-left:4px;'));
						if(isset($_SESSION['problem'])){
				    		$CI->make->H(3,'<i class="fa fa-warning"></i>'.$_SESSION['problem'],array('id'=>'trans-header','class'=>'receipt text-center text-uppercase','style'=>'color:white;font-size:20px;'));
				    	}
						// $CI->make->H(3,'',array('id'=>'up-txt','class'=>'receipt text-center','style'=>'margin-top:20px; margin-right:50px;color:white;'));
						// $CI->make->hidden('page_value',1);
					$CI->make->eDivRow();
					$CI->make->sDiv(array('class'=>'cpanel-center media-cpanel-center-cashier ','style'=>'margin-right:4px;margin-left:4px;margin-top:1px;'));
						$CI->make->sDivRow(array('class'=>'center-btns media-trans-btn'));
							// $CI->make->sDivCol(2);
							...
							$CI->make->sDivCol(2);
								$CI->make->button('<span id="status_text">'.fa('fa-arrow-up fa-2x fa-fw').'<br> '.lng('cp_btn_open').'</span>',array('class'=>'btn-block no-raduis cpanel-btn-red double btnheader stat-btn cpanel-btn-brown-orange media-btn-open media-trans-btn-width','id'=>'open-btn','type'=>'open','btn'=>'status'));
							$CI->make->eDivCol();
							$CI->make->sDivCol(2);
								...
								$CI->make->button('<span id="status_text">'.fa('fa-arrow-down fa-2x fa-fw').'<br> '.lng('cp_btn_settled').'</span>',array('class'=>'btn-block no-raduis cpanel-btn-red double btnheader stat-btn cpanel-btn-brown-orange media-btn-open media-trans-btn-width','id'=>'settled-btn','type'=>'settled','btn'=>'status'));
							$CI->make->eDivCol();
							$CI->make->sDivCol(2);
								...
								$CI->make->button('<span id="status_text">'.fa('fa-ban fa-2x fa-fw').'<br> '.lng('cp_btn_cancelled').'</span>',array('class'=>'btn-block no-raduis cpanel-btn-red double btnheader stat-btn cpanel-btn-brown-orange media-btn-open media-trans-btn-width','id'=>'cancel-btn','type'=>'cancel','btn'=>'status'));
							$CI->make->eDivCol();
							$CI->make->sDivCol(2);
								$CI->make->button('<span id="status_text">'.fa('fa-times fa-2x fa-fw').'<br> '.lng('cp_btn_voided').'</span>',array('class'=>'btn-block no-raduis cpanel-btn-red double btnheader stat-btn cpanel-btn-brown-orange media-btn-open media-trans-btn-width','id'=>'voided-btn','type'=>'voided','btn'=>'status'));
							$CI->make->eDivCol();
							$CI->make->sDivCol(2);
								$CI->make->button('ONLINE <br> ORDER',array('class'=>'btn-block no-raduis cpanel-btn-red double cpanel-btn-brown-orange media-btn-open media-trans-btn-width','id'=>'online-order-btn'));
							$CI->make->eDivCol();
							// $CI->make->sDivCol(2);
							...
							// $CI->make->eDivCol();
							$CI->make->sDivCol(2);
								$CI->make->button(fa('fa-search fa-2x fa-fw').'<br> '.lng('cp_btn_search'),array('class'=>'btn-block no-raduis cpanel-btn-red double cpanel-btn-brown-orange media-btn-open media-trans-btn-width','id'=>'look-btn'));
								$CI->make->button(fa('fa-refresh fa-2x fa-fw'),array('id'=>'refresh-btn','class'=>'btn-block no-raduis cpanel-btn-orange double hidden'));
							$CI->make->eDivCol();
							// $CI->make->sDivCol(1);
							...
							// $CI->make->eDivCol();
						$CI->make->eDivRow();
						$CI->make->sDiv(array('id'=>'prev-next-div','style'=>'margin-top:1px;height:40px;','class'=>'orders-div media-prev-next-div'));
							$CI->make->sDivRow(array('class'=>'center-btns'));
								$CI->make->sDivCol(6);
									$CI->make->sDivRow(array('id'=>'transtext-div','class'=>'media-trans-text'));
										$CI->make->H(4,'OPEN TRANSACTIONS',array('id'=>'type-txt','class'=>'receipt text-center','style'=>'margin-top:10px;color:white;'));
										$CI->make->hidden('page_trans_value',1);
										$CI->make->hidden('status_hid','open');
									$CI->make->eDivRow();
								$CI->make->eDivCol();
								$CI->make->sDivCol(3);
									$CI->make->button(fa('fa-angle-left fa-fw fa-2x').'PREVIOUS',array('class'=>'btn-block cpanel-btn-media-gray media-upper-arrow-btns','id'=>'pr-btn','style'=>''));
									// $CI->make->button(fa('fa-refresh fa-2x fa-fw'),array('id'=>'refresh-btn','class'=>'btn-block no-raduis cpanel-btn-orange double'));
								$CI->make->eDivCol();
								$CI->make->sDivCol(3);
									$CI->make->button('NEXT'.fa('fa-angle-right fa-fw fa-2x'),array('class'=>'btn-block cpanel-btn-media-blue media-upper-arrow-btns','id'=>'nxt-btn','style'=>''));
									// $CI->make->button(fa('fa-refresh fa-2x fa-fw'),array('id'=>'refresh-btn','class'=>'btn-block no-raduis cpanel-btn-orange double'));
								$CI->make->eDivCol();
							$CI->make->eDivRow();
						$CI->make->eDiv();
						$CI->make->sDiv(array('class'=>'orders-lists center-loads-div orders-div','style'=>'margin-top:5px;height:10px;'));
								...
								if(ORDER_SLIP_PRINTER_SETUP){
									$CI->make->sDivCol(6);
										$CI->make->sDivRow();
											...
											if(ORDERING_STATION){
												if(!LOCAVORE){
													$CI->make->sDivCol(6,'left',0,array("style"=>'margin-bottom:10px;'));
														...
														$CI->make->button(fa('fa-forward fa-lg fa-fw')." Update",array('id'=>'update-to-btn','class'=>'btn-block cpanel-btn-teal','style'=>'display:none;'));
													$CI->make->eDivCol();
												}
											}else{
												if($user['role_id'] == SERVER_ID){
											...
											// $CI->make->sDivCol(6,'left',0,array("style"=>''));
											// $CI->make->eDivCol();
						...
						$CI->make->sDiv(array('class'=>'reasons-div center-loads-div'));
							$CI->make->sDivRow();
								...
								$CI->make->eDivCol();
								// $CI->make->sDivCol(4,'left',0,array("style"=>'margin-bottom:10px;'));
								// 	$CI->make->button("Void Reservation",array('class'=>'btn-block cpanel-btn-teal double','id'=>'cancel-reserve-reason-btn'),'danger');
								// $CI->make->eDivCol();
								$CI->make->sDivCol(4,'left',0,array("style"=>'margin-bottom:10px;'));
					...
					$CI->make->eDiv();
				$CI->make->eDivCol();
				$CI->make->sDivCol(2,'center',0,array('class'=>'cpanel-left media-cpanel-left-cashier media-cpanel-left-width-cashier','style'=>'margin:0px;'));
					...
					$CI->make->sDivRow(array('id'=>'img-div','style'=>'height:50px'));
						// $CI->make->H(3,'IMAGE',array('id'=>'up-txt','class'=>'receipt text-center','style'=>'margin-top:20px; margin-right:50px;'));
						// $CI->make->hidden('page_value',1);
						$CI->make->sDiv(array('id'=>'load-img','style'=>'margin-right:10px;','class'=>'media-load-img'));
						$CI->make->eDiv();
					$CI->make->eDivRow();

					$CI->make->sDivRow(array('id'=>'mid-div','class'=>'media-cpanel-mid-div-cashier','style'=>' margin-top:5px;'));

						if(!ORDERING_STATION){
							if(MALL != 'megaworld'){
								$CI->make->button(lng('cp_btn_cust_deposit'),array('id'=>'cust-bank-btn','class'=>'btn-block cpanel-btn-green media-btns-height'));
							}
							// $CI->make->button(lng('cp_btn_gift_cards'),array('id'=>'gift-card-btn','class'=>'btn-block cpanel-btn-green'));
							$CI->make->button(lng('cp_btn_gift_cards'),array('id'=>'gift-card-btn','class'=>'btn-block cpanel-btn-green media-btns-height media-mid-div-margin'));
							// $CI->make->button(lng('cp_btn_loyalty_cards'),array('id'=>'loyalty-card-btn','class'=>'btn-block cpanel-btn-green'));
							$CI->make->button(lng('cp_btn_reservation'),array('id'=>'reserve-btn','class'=>'btn-block cpanel-btn-green media-btns-height media-mid-div-margin'));
						...
						// $CI->make->sDivRow(array('id'=>'nextprev-div','style'=>'height:50px'));
						// // $CI->make->sDivRow();
						// 	$CI->make->sDivCol(5,'left');
						// 		$CI->make->button(strtoupper('PREVIOUS'),array('id'=>'tprev-btn','class'=>'pn-btn btn-block cpanel-btn-red','style'=>'width:130px;'));
						// 	$CI->make->eDivCol();
						// 	$CI->make->sDivCol(5,'left');
						// 		$CI->make->button(strtoupper('NEXT'),array('id'=>'tnext-btn','class'=>'pn-btn btn-block cpanel-btn-red','style'=>'width:130px;'));
						// 	$CI->make->eDivCol();
						// $CI->make->eDivRow();
					$CI->make->eDivRow();
					$CI->make->sDivRow(array('style'=>'margin-top:5px;'));
						// $CI->make->sDivCol(11,'left',0);
							$CI->make->button(lng('cp_btn_select_brand'),array('id'=>'selbrand-btn','class'=>'btn-block cpanel-btn-teal media-slc-brand','style'=>''));
						// $CI->make->eDivCol();
					$CI->make->eDivRow();
				$CI->make->eDivCol();
				$CI->make->sDivCol(3,'center',0,array('class'=>'cpanel-left media-cpanel-left-cashier media-right-panel-cashier','style'=>''));
					...
					$CI->make->sDivRow(array('id'=>'h-div','style'=>'height:50px;'));
						$CI->make->H(3,'NEW TRANSACTION',array('id'=>'up-txt','class'=>'receipt text-center','style'=>'margin-top:20px; margin-right:50px;color:white;'));
						$CI->make->hidden('page_value',1);
					$CI->make->eDivRow();

					$CI->make->sDivRow(array('id'=>'transaction-div','class'=>'media-width-trans-type','style'=>'margin-top:5px;'));
						// $CI->make->sDiv(array('id'=>'search-trans-div','style'=>''));
						// $CI->make->eDiv();
					// $CI->make->sDiv(array('id'=>'transaction-div','style'=>'height:300px;overflow:auto;'));

						// foreach($trans_buttons as $id => $vv){

						// 	$CI->make->button(strtoupper($vv['text']),array('id'=>$vv['text_id'].'-btn','class'=>'new-order-btns btn-block cpanel-btn-blue '.$vv['new_trans_type'],'ref'=>$vv['text_id']));
						...
						// }
					$CI->make->eDivRow();
					$CI->make->sDivRow(array('id'=>'nextprev-div','class'=>'media-nextprev-div'));
					// $CI->make->sDivRow();
						$CI->make->sDivCol(5,'left',0,array('class'=>'media-btn-rmv-pdr'));
							$CI->make->button(fa('fa-chevron-left fa-2x fa-fw media-cashier-prev') .strtoupper('BACK'),array('id'=>'tprev-btn','class'=>'pn-btn btn-block cpanel-btn-kahel media-arrow-btns','style'=>''));
						$CI->make->eDivCol();
						$CI->make->sDivCol(5,'left',0,array('class'=>'media-cashier-navi-btn media-btn-rmv-pdl'));
							$CI->make->button(fa('fa-chevron-right fa-2x fa-fw media-cashier-next') .'<span class="media-cashier-next-text">NEXT</span>',array('id'=>'tnext-btn','class'=>'pn-btn btn-block cpanel-btn-dilaw media-arrow-btns','style'=>''));
						$CI->make->eDivCol();
					$CI->make->eDivRow();
					$CI->make->sDivRow(array('style'=>''));
						$CI->make->sDivCol(11,'left',0);
							$CI->make->inputsearch(null,'search-trans',null,'SEARCH',array('style'=>'','class'=>'media-search-menu'),fa('fa fa-search'));
						$CI->make->eDivCol();
					$CI->make->eDivRow();
				$CI->make->eDivCol();
			$CI->make->eDivRow();
			$CI->make->sDivRow(array('class'=>'cpanel-bottom media-cpanel-bottom-cashier ','style'=>'margin-top:80px;margin-left:0;margin-right:0'));
				if(!ORDERING_STATION){
					...
					// 	$CI->make->eDivCol();
					// // }
					$CI->make->sDivCol(4,'right','',array('class'=>''));
						$CI->make->sDivCol(4,'left','',array('class'=>''));
								// if ($user['role_id'] == 1 || $user['role_id'] == 2)
									// $CI->make->button(fa('fa-user fa-2x fa-fw').'<br> '.lng('cp_btn_manager'),array('id'=>'manager-btn','class'=>'btn-block cpanel-btn-brown-bear double col-md-offset-1-1'));
							$CI->make->button(lng('cp_btn_quick_edit'),array('id'=>'quick-edit-btn','class'=>'btn-block cpanel-btn-brown-orange double media-below-btns','style'=>''));
						$CI->make->eDivCol();
						$CI->make->sDivCol(4,'left','',array('class'=>''));
							$CI->make->button(fa('fa-print fa-2x fa-fw').'<br> '.lng('cp_btn_printer_setup'),array('id'=>'printer-setup-btn','class'=>'btn-block cpanel-btn-brown-orange double media-below-btns','style'=>''));
						$CI->make->eDivCol();
						$CI->make->sDivCol(4,'left','',array('class'=>''));
							$CI->make->button(fa('fa-clock-o fa-2x fa-fw').'<br> CLOCK IN/OUT',array('id'=>'time-clock-btn','class'=>'btn-block cpanel-btn-brown-orange double media-below-btns','style'=>''));
						$CI->make->eDivCol();						
					$CI->make->eDivCol();

					$CI->make->sDivCol(4,'left','',array('style'=>''));
						$CI->make->sDivCol(4,'left','',array('class'=>''));
							$CI->make->button('OPEN <br>DRAWER',array('id'=>'open-drawer-btn','class'=>'btn-block cpanel-btn-brown-orange double media-below-btns','style'=>''));
						$CI->make->eDivCol();
						$CI->make->sDivCol(4,'left','',array('class'=>''));
							$CI->make->button('MANAGER <br> FUNCTION ',array('id'=>'manager-btn','class'=>'btn-block cpanel-btn-brown-orange double media-below-btns','style'=>'margin-right:25px;'));
						$CI->make->eDivCol();
						$CI->make->sDivCol(4,'left','',array('class'=>''));
							$CI->make->button('BACK OFFICE <br>FUNCTION',array('id'=>'back-office-btn','class'=>'btn-block cpanel-btn-brown-orange double media-below-btns','style'=>''));
						$CI->make->eDivCol();
					...
					$CI->make->sDivCol(4,'left','',array('style'=>''));
						$CI->make->sDivCol(4,'left','',array('class'=>''));
							$CI->make->button('CUSTOMER INQ',array('id'=>'cust-inq-btn','class'=>'btn-block cpanel-btn-brown-orange double media-below-btns','style'=>''));
						$CI->make->eDivCol();
						$CI->make->sDivCol(4,'left','',array('class'=>''));
							$CI->make->button('SYNC ITEMS',array('id'=>'sync-items-btn','class'=>'btn-block cpanel-btn-brown-orange double media-below-btns','style'=>''));
						$CI->make->eDivCol();	
						$CI->make->sDivCol(4,'left','',array('class'=>''));
							$CI->make->button('SYNC DATA',array('id'=>'sync-data-btn','class'=>'btn-block cpanel-btn-brown-orange double media-below-btns','style'=>''));
						$CI->make->eDivCol();
					$CI->make->eDivCol();
			...
			$CI->make->sDiv(array('class'=>'modal-dialog','role'=>'document'));
				$CI->make->sDiv(array('class'=>'modal-content','style'=>'width: 100%;margin: 0 auto;'));
					...
					$CI->make->sDivRow();
						...
						// $CI->make->span('  ');
						$CI->make->span('*Amount Refund:');
			            $CI->make->eDivCol();
						$CI->make->sDivCol(9,'left',0,array("style"=>'margin-bottom:10px;'));
							$CI->make->input('','credit_amount',null,null,array('class'=>'count-inputs rOkay','type'=>'number','ro-msg'=>'amount refund must not be empty.'));
			            $CI->make->eDivCol();
			            $CI->make->sDivCol(3,'left',0,array("style"=>'margin-bottom:10px;'));
						// $CI->make->span('  ');
						$CI->make->span('*Credit Note No:');
			            $CI->make->eDivCol();
						$CI->make->sDivCol(9,'left',0,array("style"=>'margin-bottom:10px;'));
							$CI->make->input('','credit_note_no',null,null,array('class'=>'count-inputs rOkay','ro-msg'=>'credit note must not be empty.'));
			            $CI->make->eDivCol();
			            $CI->make->sDivCol(3,'left',0,array("style"=>'margin-bottom:10px;'));
						// $CI->make->span('  ');
						$CI->make->span('Reason');
			            $CI->make->eDivCol();
						$CI->make->sDivCol(9,'left',0,array("style"=>'margin-bottom:10px;'));
							$CI->make->textarea('','rother-reason-txt');
							// $CI->make->input('','credit_amount',null,null,array('class'=>'count-inputs rOkay','ro-msg'=>'credit note must not be empty.'));
			            $CI->make->eDivCol();
			            $CI->make->sDivCol(12,'right',0,array("style"=>'margin-bottom:10px'));
			            $CI->make->button(' Cancel',array('data-dismiss'=>'modal','style'=>'margin-right:10px'));
						$CI->make->button(' Submit',array('id'=>'save-reserve-reason-btn', 'class'=>'',"style"=>'color:#fff;background-color:#008d4c!important'));
						$CI->make->eDivCol();
					$CI->make->eDivRow();
				$CI->make->eDiv();
			$CI->make->eDiv();
...
function counterPage($type=null,$time=null,$loaded=null,$order=array(),$typeCN=array(),$local_tax=0,$kitchen_printer=null,$app_type=null,$is_multibrand=0,$update='',$brand_name=''){
	$CI =& get_instance();
		$user = $CI->session->userdata('user');
		$CI->make->sDiv(array('id'=>'counter'));
			$CI->make->sDivRow();
				$CI->make->sDivCol(12,'left',0,array('id'=>'mods_mandatory_div'));
				$CI->make->hidden('is_update',$update);
				$CI->make->hidden('menu_categories_page',1);
				$CI->make->hidden('menu_page',1);
				$CI->make->hidden('subcat_menu_page',1);
				...
				#LEFT
				$CI->make->sDivCol(6,'',0,array('class'=>'left-panel-media-width'));
					$CI->make->sDivRow(array('id'=>'notif-div','style'=>'height:55px;background-color:red;'));
								if(isset($_SESSION['problem'])){
						    		$CI->make->H(3,'<i class="fa fa-warning"></i>'.$_SESSION['problem'],array('id'=>'trans-header','class'=>'receipt text-center text-uppercase','style'=>'color:white;font-size:20px;'));
						    	}
								if(IS_RETAIL){
									$CI->make->sDivRow();
										...
										$CI->make->eDivCol();
										$CI->make->sDivCol(6);
											$CI->make->H(4,'BARCODE SCAN READY',array('id'=>'scan-txt','class'=>'receipt text-center','style'=>'margin-top:20px; margin-right:50px;color:white;'));
										$CI->make->eDivCol();
									$CI->make->eDivRow();
								}else{
									$CI->make->H(3,'',array('id'=>'up-txt','class'=>'receipt text-center','style'=>'margin-top:20px; margin-right:50px;color:white;'));
								...
								// $CI->make->hidden('page_value',1);
					$CI->make->eDivRow();
					$CI->make->sDiv(array('class'=>'center-div counter-center list-div',"style"=>'height:100%;background: #F2F2F2;'));
						$CI->make->sDivRow();
							$CI->make->sDivCol(12,'left',0,array('class'=>'title media-title'));
						    	$tableN = null;
						    	$guestN = 1;
						    	$serveN = null;
								...
								$waiterTxt = '<span id="trans-server-txt">'.$waiter.'</span>';
						// echo $app_type;
								// if($type== 'dinein'){
						...
						$CI->make->eDivRow();
						$CI->make->sDivRow();
							$CI->make->sDivCol(4,'left',0,array('class'=>'foot','style'=>'height:135px;background-color:#0070C0;color:#fff;'));
								// $CI->make->append('<hr>');
								$CI->make->sDiv(array('class'=>'foot-det','style'=>'margin-left:5px'));
									$CI->make->sDivCol(12);
										$CI->make->span(date("d M y"));
									$CI->make->eDivCol();
									$CI->make->sDivCol(12);
										date_default_timezone_set("Asia/Manila");
										$CI->make->span(date("h:i:s A"));
									$CI->make->eDivCol();
									// $CI->make->sDivCol(12);
									// 	$CI->make->span('Trans No:');
									// $CI->make->eDivCol();
									$CI->make->sDivCol(12);
										// $CI->make->span('Guest #: <span id="ord-guest-no">'.$guestN.'</span>');

										if($guestN != null){
											if($guestN  == 0){
												$guestN = 1;
											}
											$guestNtxt = 'Guest #<span id="ord-guest-no">'.$guestN.'</span> <a href="#" id="edit-order-guest-no" style="color:#fff">'.fa('fa-edit fa-lg').'</a>';
										}

										$CI->make->span($guestNtxt,array('id'=>'trans-datetime','class'=>'text-center'));
									$CI->make->eDivCol();
									$CI->make->sDivCol(12);
										if($type== 'dinein'){
											$CI->make->span(strtoupper(DINEINTEXT));
										}elseif($type== 'counter'){
											$CI->make->span(strtoupper(COUNTERTEXT));
										}elseif($type=='takeout'){
											$CI->make->span(strtoupper(TAKEOUTTEXT));
										}elseif($app_type=='App%20Order'){
											$CI->make->span(strtoupper('App Order'));
										}else{
											$CI->make->span(strtoupper($type));
										}
									$CI->make->eDivCol();
									$CI->make->sDivCol(12);
											$CI->make->span($tableN);
									$CI->make->eDivCol();
									$CI->make->sDivCol(12);
											$CI->make->span($serveNtxt);
									$CI->make->eDivCol();
									$CI->make->sDivCol(12);
											$CI->make->span($waiterTxt);
									$CI->make->eDivCol();
								$CI->make->eDiv();
							$CI->make->eDivCol();
							$CI->make->sDivCol(8,'left',0,array('class'=>'foot','style'=>'height:135px;background-color:#7F7F7F;color:#fff;'));
						...
						$CI->make->eDivRow();
						$CI->make->sDivRow();
							$CI->make->sDivCol(4,'left',0,array('class'=>'foot','style'=>'height:65px;','id'=>'load-img'));
							 $thumb = base_url().'img/max.png';
							$CI->make->img($thumb,array('style'=>'','class'=>'max-image'));
							$CI->make->eDivCol();
							$CI->make->sDivCol(8,'left',0,array('class'=>'foot','style'=>'height:65px;'));
							$CI->make->sDivCol(9,'right',3);
										$CI->make->span($brand_name,array('class'=>'bname'));
									$CI->make->eDivCol();
							$CI->make->eDivCol();
						$CI->make->eDivRow();
					$CI->make->eDiv();
					...
					// 						$CI->make->sDivCol(4);
					// 							$CI->make->button(fa('fa-arrow-right fa-lg fa-fw').' SETTLE',array('id'=>'settle-btn','class'=>'btn-block counter-btn-teal double','style'=>'height:62px!important;'));
					// 						$CI->make->eDivCol();
					// 					}
					// 				}
					// 				else{
				...
				// $CI->make->eDivCol();
				#ITEMS
				$CI->make->sDivCol(4,'left',0,array('class'=>'media-center-div-panel'));
					...
					$CI->make->sDiv(array('class'=>'counter-right media-counter-right','style'=>'overflow:hidden;background-color:#255F93'));
						// $CI->make->sDiv(array('class'=>'brandname-div','style'=>''));
						// 	$CI->make->H(3,$brand_name,array('class'=>'bname text-center title','style'=>'margin-bottom:10px'));
						// $CI->make->eDiv();
						// $CI->make->sDivCol(12,'left',0);
						// 	$CI->make->input(null,'search-menu',null,null,array('style'=>'height:60px;'),fa('fa fa-search')." Menu");
						// $CI->make->eDivCol();
						#CATEGORY
						$CI->make->sDiv(array('class'=>'category-div loads-div','style'=>''));
							$CI->make->sDiv(array('class'=>'','style'=>'background-color:#255F93;height:16px;overflow:hidden;'));
								// $CI->make->sDivCol(12,'left',0,array('style'=>'display:none','class'=>'search-display'));
								// 	$CI->make->input(null,'search-menu',null,null,array('style'=>'height:30px;'),fa('fa fa-search')." Menu");
								// $CI->make->eDivCol();
							$CI->make->eDiv();
							if($type== 'dinein'){
									$CI->make->sDiv(array('style'=>'margin-bottom:35px','class'=>'media-header-width'));
										$CI->make->sDivCol(3,'left',0);
											$CI->make->H(3,strtoupper(DINEINTEXT),array('id'=>'trans-header','class'=>'receipt text-center text-uppercase','style'=>'color:#000;background-color:#fff;border-radius: 10px;'));
										$CI->make->eDivCol();
										$CI->make->sDivCol(9,'left',0);
											$CI->make->H(3,"<span style='float:right;padding-right:80px'> MAIN CATEGORY</span>",array('id'=>'trans-header','class'=>'receipt text-center text-uppercase','style'=>'color:#fff'));
										$CI->make->eDivCol();
									$CI->make->eDiv();
									...
									$CI->make->sDiv(array('style'=>'margin-bottom:35px','class'=>'media-header-width'));
										$CI->make->sDivCol(3,'left',0);
											$CI->make->H(3,strtoupper(COUNTERTEXT),array('id'=>'trans-header','class'=>'receipt text-center text-uppercase','style'=>'color:#000;background-color:#fff;border-radius: 10px;'));
										$CI->make->eDivCol();
										$CI->make->sDivCol(9,'left',0);
											$CI->make->H(3,"<span style='float:right;padding-right:80px'> MAIN CATEGORY</span>",array('id'=>'trans-header','class'=>'receipt text-center text-uppercase','style'=>'color:#fff'));
										$CI->make->eDivCol();
									...
									$CI->make->sDiv(array('style'=>'margin-bottom:35px','class'=>'media-header-width'));
										$CI->make->sDivCol(3,'left',0);
											$CI->make->H(3,strtoupper(TAKEOUTTEXT),array('id'=>'trans-header','class'=>'receipt text-center text-uppercase','style'=>'color:#000;background-color:#fff;border-radius: 10px;'));
										$CI->make->eDivCol();
										$CI->make->sDivCol(9,'left',0);
											$CI->make->H(3,"<span style='float:right;padding-right:80px'> MAIN CATEGORY</span>",array('id'=>'trans-header','class'=>'receipt text-center text-uppercase','style'=>'color:#fff'));
										$CI->make->eDivCol();
									...
									$CI->make->sDiv(array('style'=>'margin-bottom:35px','class'=>'media-header-width'));
										$CI->make->sDivCol(3,'left',0);
											$CI->make->H(3,strtoupper('App Order'),array('id'=>'trans-header','class'=>'receipt text-center text-uppercase','style'=>'color:#000;background-color:#fff;border-radius: 10px;'));
										$CI->make->eDivCol();
										$CI->make->sDivCol(9,'left',0);
											$CI->make->H(3,"<span style='float:right;padding-right:80px'> MAIN CATEGORY</span>",array('id'=>'trans-header','class'=>'receipt text-center text-uppercase','style'=>'color:#fff'));
										$CI->make->eDivCol();
									...
									$CI->make->sDiv(array('style'=>'margin-bottom:35px','class'=>'media-header-width'));
										$CI->make->sDivCol(6,'left',0);
											$CI->make->H(3,strtoupper($type),array('id'=>'trans-header','class'=>'receipt text-center text-uppercase','style'=>'color:#000;background-color:#fff;border-radius: 10px;'));
										$CI->make->eDivCol();
										$CI->make->sDivCol(6,'left',0);
											$CI->make->H(3,"<span style='float:right;'> MAIN CATEGORY</span>",array('id'=>'trans-header','class'=>'receipt text-center text-uppercase','style'=>'color:#fff'));
										$CI->make->eDivCol();
									$CI->make->eDiv();
								}
							// $CI->make->H(3,'CATEGORIES',array('class'=>'receipt text-center title','style'=>'margin-bottom:10px;'));
							$CI->make->sDiv(array('class'=>'category-lists media-width-category','style'=>'overflow:hidden;'));
						 	 	// $CI->make->hidden('mods-mandatory',"0",array("class"=>"mods-mandatory"));
						 	 	// $CI->make->hidden('mod-group-name',null,array("class"=>"mod-group-name"));
							$CI->make->eDiv();
						$CI->make->eDiv();
						...
						#MENU
						$CI->make->sDiv(array('class'=>'menus-div loads-div media-width-menu','style'=>'display:none;'));
							// $CI->make->sDiv(array('class'=>'items-search','style'=>'background-color:#fff;height:70px;overflow:hidden;'));
								// if($is_multibrand == 1){
								// 	$CI->make->sDivCol(3,'left',0);
								// 		$CI->make->button('Select Brand',array('id'=>'selbrand-btn','class'=>'btn-block counter-btn-teal','style'=>'height:60px;'));
								// 	$CI->make->eDivCol();
								// 	$CI->make->sDivCol(9,'left',0);
								// 		$CI->make->input(null,'search-menu',null,null,array('style'=>'height:60px;'),fa('fa fa-search')." Menu");
								// 	$CI->make->eDivCol();
								...
								// }
							// $CI->make->eDiv();
							// $CI->make->H(3,'&nbsp;',array('class'=>'receipt text-center title','style'=>'margin-bottom:10px;color:#fff'));
							$CI->make->sDiv(array('style'=>'margin-bottom:15px'));
								$CI->make->sDivCol(4,'left',0,array('class'=>'media-category-title'));
									$CI->make->H(3,strtoupper($type),array('id'=>'trans-header','class'=>'receipt text-center text-uppercase','style'=>'color:#000;background-color:#fff;border-radius: 10px;'));
								$CI->make->eDivCol();
								...
								$CI->make->eDivCol();
							$CI->make->eDiv();
							$CI->make->sDiv(array('class'=>'items-lists media-items-list','style'=>'height:445px;overflow:hidden;'));
							$CI->make->eDiv();
						$CI->make->eDiv();
						#MODS
						$CI->make->hidden('mod_seq',1);
						$CI->make->hidden('mod_seq_last',1);
						$CI->make->sDiv(array('class'=>'mods-div loads-div media-width-mods','style'=>'display:none'));
							$CI->make->H(3,'MODIFIERS',array('class'=>'receipt text-center title media-mod-title','style'=>'margin-bottom:10px'));
							$CI->make->sDiv(array('class'=>'mods-lists media-mod-divs','style'=>''));
						 	 	$CI->make->hidden('mods-mandatory',"0",array("class"=>"mods-mandatory"));
						 	 	$CI->make->hidden('mod-group-name',null,array("class"=>"mod-group-name"));
							$CI->make->eDiv();
						$CI->make->eDiv();
						#SUB MODS
						$CI->make->hidden('submod_seq',1);
						$CI->make->hidden('submod_seq_last',1);
						$CI->make->sDiv(array('class'=>'submods-div loads-div','style'=>'display:none'));
							$CI->make->H(3,'SUB MODIFIERS',array('class'=>'receipt text-center title','style'=>''));
						...
						$CI->make->sDiv(array('class'=>'subcategory-div loads-div','style'=>'display:none'));
							$CI->make->sDiv(array('class'=>'items-search','style'=>'background-color:#255F93;height:20px;overflow:hidden;'));
							...
							$CI->make->sDiv(array('class'=>'subcategory-lists media-subcategory-lists','style'=>''));
							$CI->make->eDiv();
						$CI->make->eDiv();
								...
								$CI->make->sDiv(array('class'=>'counter-center-btns'));
									$CI->make->sDivRow();
										...
										$CI->make->sDivCol(6);
											...
											$CI->make->button('Finished',array('id'=>'multiply-items','class'=>'btn-block counter-btn-green double','operator'=>'times'));
										$CI->make->eDivCol();
									$CI->make->eDivRow();
								$CI->make->eDiv();
							$CI->make->eDiv();
						...
						$CI->make->sDiv(array('class'=>'sel-discount-div loads-div','style'=>'display:none'));
							...
							$CI->make->sDivRow();
										 	$CI->make->sDivCol(12,'left');
												$CI->make->button(fa('fa-times fa-lg fa-fw').' CLOSE',array('id'=>'','class'=>'btn-block counter-btn-orange double transactions-close-btn'));
											$CI->make->eDivCol();
								 $CI->make->eDivRow();
						$CI->make->eDiv();
						...
						$CI->make->eDiv();
						#Choose didscount
						$CI->make->sDiv(array('class'=>'choosedisc-div loads-div','style'=>'height:585px;overflow:auto;display:none'));
							$CI->make->H(3,'Select Discount Type',array('class'=>'receipt text-center title','style'=>'margin-bottom:10px'));
							$CI->make->sDiv(array('class'=>'option-lists row'));
								$CI->make->sDivCol(12);
						...
						$CI->make->sDiv(array('class'=>'counter-center-btns center-div list-div',"style"=>"margin-top: 1px;"));
							$CI->make->sDivRow();
							// #eto ung sa search
								// $CI->make->sDiv(array('class'=>'items-search','style'=>'background-color:#fff;height:70px;overflow:hidden;'));
							// 	$CI->make->sDivCol(12,'left',0);
							...
							// #search end
							if($update == ''){
								$CI->make->sDivCol(2,"",0,array('class'=>'center-btn-div search-btn-panel'));
									$CI->make->button(fa('fa-search fa-lg fa-fw').'SEARCH',array('id'=>'display-search-btn','class'=>'btn-block  double media-srch-btn','style'=>''));
								$CI->make->eDivCol();
							}
								

								$CI->make->sDivCol(3,"",0,array('style'=>'display:none','class'=>'search-display '));
									$CI->make->button(fa('fa-search fa-lg fa-fw').'CANCEL',array('id'=>'cancel-search-btn','class'=>'btn-block  double media-cancel-search-btn','style'=>''));
								$CI->make->eDivCol();

								$CI->make->sDivCol(7,'left',0,array('style'=>'display:none','class'=>'search-display search-display-input media-dis-search'));
											$CI->make->input(null,'search-menu',null,null,array('style'=>'height:60px;'));
								$CI->make->eDivCol();

								$CI->make->sDivCol(4,"",0,array('class'=>'center-btn-div cancel-btn-panel'));
								$CI->make->button('CANCEL',array('id'=>'cancel-btn','class'=>'btn-block double media-cancel-btn','style'=>''));
								$CI->make->eDivCol();
								if(!ORDERING_STATION && $update == ''){
									$CI->make->sDivCol(6,"",0,array('class'=>'center-btn-div settle-btn-panel'));
										$CI->make->button(' SETTLE',array('id'=>'settle-btn','class'=>'btn-block double media-sett-btn','style'=>''));
									$CI->make->eDivCol();
								}
								
							$CI->make->eDivRow();
						$CI->make->eDiv();
						$CI->make->sDiv(array('class'=>'number-center-btns center-div list-div',"style"=>"margin-top: 5px;"));
							$CI->make->sDivRow();
								$CI->make->sDivCol(2);
									$CI->make->button('1',array('id'=>'display-search-btn','class'=>'btn-block  double num-qty media-number-btns','style'=>'','num'=>1));
									$CI->make->button('7',array('id'=>'display-search-btn','class'=>'btn-block  double num-qty media-number-btns','style'=>'','num'=>7));
								$CI->make->eDivCol();
								$CI->make->sDivCol(2);
									$CI->make->button('2',array('id'=>'display-search-btn','class'=>'btn-block  doubl num-qty media-number-btns','style'=>'','num'=>2));
									$CI->make->button('8',array('id'=>'display-search-btn','class'=>'btn-block  double num-qty media-number-btns','style'=>'','num'=>8));
								$CI->make->eDivCol();
								$CI->make->sDivCol(2);
									$CI->make->button('3',array('id'=>'display-search-btn','class'=>'btn-block  double num-qty media-number-btns','style'=>'','num'=>3));
									$CI->make->button('9',array('id'=>'display-search-btn','class'=>'btn-block  double num-qty media-number-btns','style'=>'','num'=>9));
								$CI->make->eDivCol();
								$CI->make->sDivCol(2);
									$CI->make->button('4',array('id'=>'display-search-btn','class'=>'btn-block  double num-qty media-number-btns','style'=>'','num'=>4));
									$CI->make->button('0',array('id'=>'display-search-btn','class'=>'btn-block  double num-qty media-number-btns','style'=>'','num'=>'0'));
								$CI->make->eDivCol();
								$CI->make->sDivCol(2);
									$CI->make->button('5',array('id'=>'display-search-btn','class'=>'btn-block  double num-qty media-number-btns','style'=>'','num'=>5));
									$CI->make->button('.',array('id'=>'display-search-btn','class'=>'btn-block  double num-qty media-number-btns','style'=>'','num'=>'.'));
								$CI->make->eDivCol();
								$CI->make->sDivCol(2);
									$CI->make->button('6',array('id'=>'display-search-btn','class'=>'btn-block  double num-qty media-number-btns','style'=>'','num'=>6));
									$CI->make->button('CLEAR',array('id'=>'clear-qty-btn','class'=>'btn-block  double media-number-clear','style'=>''));
								$CI->make->eDivCol();
								$CI->make->hidden('num-qty','');
							$CI->make->eDivRow();
						$CI->make->eDiv();
					$CI->make->eDiv();
					// $CI->make->button(fa('fa-chevron-circle-down fa-2x fa-fw'),array('id'=>'menu-item-scroll-down','class'=>'btn-block counter-btn double'));
				...
				#RIGHT
				$CI->make->sDivCol(2,'left',0,array('class'=>'counter-left media-ctr-left-background'));
					// $CI->make->button("",array('id'=>'','class'=>'btn-block counter-btn-red double'));

					$CI->make->button('Select<br> MGI&nbsp;Brand',array('id'=>'selbrand-btn','class'=>'btn-block media-sel-brand-btn','style'=>''));
					$CI->make->sDivCol(12,'left',0);
						$CI->make->button('TAKE OUT',array('id'=>'take-all-btn','class'=>'btn-block  double media-send-kitc-btn','style'=>''));
						// if($type== 'reservation'){
						// 	$CI->make->button('SEND TO KITCHEN',array('id'=>'rhold-all-btn','class'=>'btn-block counter-btn-red double','style'=>'height:60px!important;border:solid #BFBFBF 3px;background-color:#70AD47!important;width:130px;margin-bottom:-3px;'));
						// }else{
						$CI->make->button('SEND TO KITCHEN',array('id'=>'submit-btn','class'=>'btn-block double media-send-kitc-btn','style'=>''));
						// }
						// if(SERVER_NO_SETUP && isset($typeCN[0]['type']) && $typeCN[0]['type'] == 'counter' || SERVER_NO_SETUP && isset($typeCN[0]['type']) && $typeCN[0]['type'] == 'takeout'){
							$CI->make->button('SERVE NO.',array('id'=>'serve-no-btn','class'=>'btn-block double media-send-kitc-btn','style'=>''));
						// }else{
							// $CI->make->button('FOOD SERVER',array('id'=>'waiter-btn','class'=>'btn-block counter-btn-red double','style'=>'height:60px;border:solid #BFBFBF 3px;background-color:#70AD47!important;width:130px;margin-bottom:-3px;'));

							$CI->make->button('RESET QTY',array('value'=>'1','operator'=>'equal','id'=>'resetqty-btn','class'=>'btn-block double media-send-kitc-btn','style'=>''));

							// $CI->make->button('Reset',array('value'=>'1','operator'=>'equal','class'=>'btn-block edit-qty-btn counter-btn-red double'));
						// }
						$CI->make->button('ADD REMARKS',array('id'=>'remarks-btn','class'=>'btn-block media-send-kitc-btn double','style'=>''));
						$CI->make->button('REMOVE',array('id'=>'remove-btn','class'=>'btn-block media-send-kitc-btn double '.$loaded,'style'=>''));
						
					// $CI->make->eDivCol();
					// $CI->make->sDivCol(6,'left',0);
						$CI->make->button('FREE',array('id'=>'free-btn','class'=>'btn-block media-send-kitc-btn double','style'=>''));
						$CI->make->button('HOLD ALL',array('id'=>'hold-all-btn','class'=>'btn-block media-send-kitc-btn double','style'=>''));
						$CI->make->button('ADD CHARGES',array('id'=>'charges-btn','class'=>'btn-block  media-send-kitc-btn double','style'=>''));
						if(ORDERING_STATION){
							$CI->make->button('ADD DISCOUNT',array('id'=>'no-discount-btn','class'=>'btn-block media-send-kitc-btn double','style'=>''));
						}else{
							$CI->make->button('ADD DISCOUNT',array('id'=>'add-discount-choose-btn','class'=>'btn-block media-send-kitc-btn double','style'=>''));						
						}

						if($type == 'reservation'){
							$CI->make->button('SUBMIT RESERVATION',array('id'=>'rhold-all-btn','class'=>'btn-block media-send-kitc-btn double','style'=>''));
						}
						// $CI->make->button('QUANTITY',array('id'=>'qty-btn','class'=>'btn-block counter-btn-red double','style'=>'height:60px;border:solid #BFBFBF 3px;background-color:#70AD47!important'));
					...
					// 		$CI->make->button(fa('fa-ticket fa-lg fa-fw').'<br> Serve No.',array('id'=>'serve-no-btn','class'=>'btn-block counter-btn-red double'));
					// 	}
					// 	else{
					...
					// }else{
						...
						// $CI->make->button(fa('fa-tags fa-lg fa-fw').'<br> Quantity',array('id'=>'qty-btn','class'=>'btn-block counter-btn-red double'));
						// if(ORDERING_STATION){
						// 	$CI->make->button(fa('fa-certificate fa-lg fa-fw').'<br> Add Discount',array('id'=>'no-discount-btn','class'=>'btn-block counter-btn-red double'));
						// }else{
						// 	$CI->make->button(fa('fa-certificate fa-lg fa-fw').'<br> Add Discount',array('id'=>'add-discount-choose-btn','class'=>'btn-block counter-btn-red double'));						
						// }
...
function settlePage($ord=null,$det=null,$discs=null,$totals=null,$charges=null,$trans_retake=false,$payment_types=null,$gc_types=null,$payment_group=null){
	$CI =& get_instance();
		...
		$display = $ord['paid'] == 1 ? 'none' : 'block';

		$CI->make->sDiv(array('class'=>'media-settle-panel','id'=>'settle','retrack'=>$ret,'sales'=>$ord['sales_id'],'type'=>$ord['type'],'balance'=>num($ord['balance'])));
			
			// $CI->make->input(null,'search-payment',null,null,array(),fa('fa fa-search')." Search Payment");
			$CI->make->sDivRow();	
				$CI->make->sDivCol(5,'left',0,array('class'=>'payment-divs bg-red','style'=>'height:72px'));
				$CI->make->eDivCol();
				$CI->make->sDivCol(4,'left',0,array('class'=>'payment-divs media-bg-payment','style'=>'display:'. $display));
					$CI->make->sDivRow(array('id'=>'paymentgroup-div','class'=>'settle-right','style'=>'height:72px;padding:0px'));					
						...
						// 	$CI->make->sDivCol('2','left',0,array("style"=>'','id'=>'pg-div'));
					...
					$CI->make->sDivCol('','left',0,array('class'=>'settle-right',"style"=>'display:none;height:72px;padding:0px','id'=>'ptype-div'));
					$CI->make->eDivCol();
					...
					// 	$CI->make->eDivCol();
					// $CI->make->eDivRow();
					$CI->make->hidden('pg_page_value','1');
					$CI->make->hidden('page_value','1');
					$CI->make->hidden('p_group_id','1');

				$CI->make->eDivCol();	

				$CI->make->sDivCol(2,'left',0,array('class'=>'payment-divs media-bg-payment'));
					$CI->make->sDivCol(6,'left',0,array('class'=>'payment-divs ','style'=>'display:'. $display));
						$CI->make->button(fa('fa-angle-left fa-fw fa-2x'),array('class'=>'btn-block cpanel-btn-media-blue','id'=>'pgprev-btn','style'=>'height:40px;width:70px'));
						$CI->make->button(fa('fa-angle-left fa-fw fa-2x'),array('class'=>'btn-block cpanel-btn-media-blue','id'=>'sprev-btn','style'=>'height:40px;width:70px'));
						// $CI->make->button('<',array('id'=>'pgprev-btn','class'=>'btn-block settle-btn-teal double','style'=>'width:80px;font-size:30px'));
						// $CI->make->button('<',array('id'=>'sprev-btn','class'=>'btn-block settle-btn-teal double','style'=>'display:none;width:80px;font-size:30px'));
					$CI->make->eDivCol();

					$CI->make->sDivCol(6,'left',0,array('class'=>'payment-divs','style'=>'display:'. $display));
						// $CI->make->button('>',array('id'=>'pgnext-btn','class'=>'btn-block settle-btn-teal double','style'=>'width:80px;font-size:30px'));
						// $CI->make->button('>',array('id'=>'snext-btn','class'=>'btn-block settle-btn-teal double','style'=>'display:none;width:80px;font-size:30px'));
						$CI->make->button(fa('fa-angle-right fa-fw fa-2x'),array('class'=>'btn-block cpanel-btn-media-blue','id'=>'pgnext-btn','style'=>'height:40px;width:70px'));
						$CI->make->button(fa('fa-angle-right fa-fw fa-2x'),array('class'=>'btn-block cpanel-btn-media-blue','id'=>'snext-btn','style'=>'height:40px;width:70px'));

						
					$CI->make->eDivCol();

					$CI->make->sDivCol(12,'left',0,array('class'=>'payment-divs','style'=>'display:'. $display));
						$CI->make->input(null,'search-payment',null,'Search Payment',array('style'=>'','class'=>'media-search-payment'));
					$CI->make->eDivCol();
				...
				$CI->make->sDivCol(1,'left',0,array('class'=>'payment-divs media-bg-payment','style'=>'display:'. $display));
					$CI->make->button('BACK',array('id'=>'prev-btn','class'=>'btn-block settle-btn-orange double', 'style'=>'height:74px;display:none'));
				$CI->make->eDivCol();				
			...
			$CI->make->sDivRow();
						...
						$CI->make->sBoxBody();
						   ...
						   //      $CI->make->H(5,sql2DateTime($ord['datetime'])." ".$waiter,array('class'=>'receipt text-center'));
						        ...
						        $CI->make->sDiv(array('class'=>'foot-det','style'=>'margin-left:5px;margin-right:5px'));
									...
									$CI->make->eDivCol();
									$CI->make->sDivCol(6);
										$CI->make->span(num($ord['balance']),array("style"=>"float:right",'id'=>'amount-due-txt'));
									$CI->make->eDivCol();
									// $CI->make->H(3,'TOTAL: <span id="total-txt">0.00</span>',array('class'=>'receipt text-center'));
									// $lt_txt = "";
									// if($local_tax > 0){
									...
									// $CI->make->H(5,'DISCOUNTS: <span id="discount-txt">0.00</span> '.$lt_txt,array('class'=>'receipt text-center'));
								$CI->make->eDiv();
						        $CI->make->H(5,'TOTAL: PHP '.num($ord['amount']),array('class'=>'receipt text-center'));
						        // $lt_txt = "";
						...
						$CI->make->sBoxFoot();
							$CI->make->sDivRow();
								if($ord['balance'] == 0){
									...
									$CI->make->eDivCol();
									$CI->make->sDivCol(3,'left');
										$CI->make->button(fa('fa-reply fa-lg fa-fw').' Recall',array('id'=>'recall-btn','type'=>$ord['type'],'sale'=>$ord['sales_id'],'class'=>'btn-block settle-btn-teal double'));
									$CI->make->eDivCol();
									$CI->make->sDivCol(3,'left');
										$CI->make->button(fa('fa-times fa-lg fa-fw').' Cancel',array('id'=>'cancel-btn','type'=>$ord['type'],'class'=>'btn-block settle-btn-red double'));
									$CI->make->eDivCol();
									...
									if(round($ord['amount'],2) == round($ord['balance'],2)){
										$CI->make->button(fa('fa-credit-card fa-lg fa-fw').' Discount',array('id'=>'discount-btn','type'=>$ord['type'],'sale'=>$ord['sales_id'],'class'=>'btn-block settle-btn-green double'));
									}else{
										$CI->make->button(fa('fa-credit-card fa-lg fa-fw').' Discount',array('id'=>'discount-btn','type'=>$ord['type'],'sale'=>$ord['sales_id'],'class'=>'btn-block settle-btn-green double','disabled'=>'disabled'));
									}
									$CI->make->eDivCol();
								}
							$CI->make->eDivRow();
				...
				$CI->make->sDivCol(7,'left',0,array('class'=>'settle-right media-settle-right'));
				if($ord['paid'] == 1){
					...
					foreach ($payment_types as $id => $value) {
						...
						// if($value->payment_code != 'cash' && $value->payment_code != 'credit' && $value->payment_code != 'debit' && $value->payment_code != 'chit' && $value->payment_code != 'gc'){
							...
							$CI->make->sBoxHead(array('class'=>'bg-green'));
								$CI->make->boxTitle($value->description.' PAYMENT',array('style'=>'float:left'));
								if(in_array($value->payment_code, array('arclearingbilling','arclearingpromo'))){
									$CI->make->boxTitle('AVAILABLE CREDIT: PHP <span id="balance-cust-txt">0.00</span>',array('class'=>'pull-right','style'=>'margin-right:10px;'));
								}
							$CI->make->eBoxHead();
								...
								$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
									$CI->make->sDivCol(6);
										...
										foreach($fields as $id => $val){
											$paymaya_class = $value->payment_code == 'paymaya' && $paymaya_class =='' ? 'paymaya-inp' : '';
											if($val->inactive != 1){
												$CI->make->input($val->field_name,$value->payment_code.'-'.$val->field_id,'','',array('maxlength'=>'100',
													...
													'class'=>$value->payment_code.'-field'. ' '.$paymaya_class,
													'style'=>
														'width:100%;
														height:100%;
														font-size:34px;
					...
					$CI->make->sBox('default',array('class'=>'loads-div after-payment-div box-solid media-after-cash-payment'));
						...
						$CI->make->sBoxBody(array('class'=>'bg-dark-green'));
							...
							$CI->make->sDivRow();
								...
								$CI->make->eDivCol();
								$CI->make->sDivCol(3,'left');
									$CI->make->button(fa('fa-print fa-lg fa-fw').' Print Receipt',array('id'=>'print-btn','class'=>'btn-block settle-btn-orange double','style'=>'height:70px','ref'=>$ord['sales_id']));
								$CI->make->eDivCol();
								$CI->make->sDivCol(3,'left');
								...
								$CI->make->eDivCol();
								$CI->make->sDivCol(3,'left');
									$CI->make->button(fa('fa-print fa-lg fa-fw').'Print PDF',array('id'=>'print-pdf-btn','class'=>'btn-block settle-btn-red double','style'=>'height:70px','ref'=>$ord['sales_id']));
								$CI->make->eDivCol();
							$CI->make->eDivRow();
						$CI->make->eBoxBody();
					$CI->make->eBox();
						...
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								...
								$CI->make->sDivCol(6);
									...
									$CI->make->hidden('cust-balance-val',null);
					...
					$CI->make->sBox('default',array('class'=>'loads-div sel-discount-div box-solid ','style'=>'display:none;'));
						...
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDiv(array('class'=>'select-discounts-lists media-sel-discount-lists','style'=>'overflow:auto'));
							$CI->make->eDiv();
						$CI->make->eBoxBody();
					$CI->make->eBox();
					...
					$CI->make->sBox('default',array('class'=>'loads-div discount-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' SELECT DISCOUNT',array('class'=>'text-center'));
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;','class'=>'media-dis-div'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;','class'=>'media-checkout-disc'));
								$CI->make->sDiv();
									$CI->make->H(3,'&nbsp;',array('class'=>'receipt text-center title','style'=>'margin-bottom:10px'));
									$CI->make->H(3,'RATE: % <span id="rate-txt"></span>',array('class'=>'receipt text-center','style'=>'margin-bottom:10px'));
									$CI->make->sDiv(array('class'=>'discounts-lists'));
										 ...
										 $CI->make->sForm("",array('id'=>'disc-form'));
											 ...
											 $CI->make->sDivRow();
												 $CI->make->sDivCol(12);
												 	$CI->make->sDiv(array('class'=>'disc-persons-list-div listings','style'=>'overflow:auto;'));
													$CI->make->eDiv();
											 	 $CI->make->eDivCol();
											 $CI->make->eDivRow();
										 $CI->make->eForm();
			...
			$CI->make->sDiv(array('class'=>'occupied-div loads-div','style'=>'display:none;'));
				$CI->make->sDiv(array('class'=>'nav-btns-con'));
					$CI->make->sDivRow();
						$CI->make->sDivCol(10);
							$CI->make->sDiv(array('class'=>'title bg-red'));
								$CI->make->H(3,'<span id="occ-num"></span> Is In Use <span id="combined-msg"></span>',array('class'=>'headline text-center text-uppercase','style'=>'padding:12px;'));
							$CI->make->eDiv();
						$CI->make->eDivCol();
						$CI->make->sDivCol(2);
							$CI->make->sDiv(array('class'=>'exit'));
	...
	$CI->make->sDiv(array('id'=>'cashier-panel','style'=>'margin-top:10px;','class'=>'div-no-spaces'));
		...
		ksort($tables);
			foreach ($tables as $id => $opt) {
		        ...
		        //   $occ[] = $det->table_id;
		        // }
		        $where = array('combined_tbl_id'=>$id);
				$occ_com = $CI->cashier_model->get_combined_tables($where);
				...
				$CI->make->sDivCol(5,'left',0);
					...
					$CI->make->sDiv(array('class'=>'counter-right','style'=>'height:630px;overflow:hidden;'));
						...
						$CI->make->sDiv(array('class'=>'menus-div loads-div','style'=>'display:none'));
							$CI->make->sDiv(array('class'=>'items-search','style'=>'background-color:#fff;height:20px;overflow:hidden;'));
								$CI->make->input(null,'search-menu',null,null,array(),fa('fa fa-search')." Menu");
							$CI->make->eDiv();
							$CI->make->H(3,'&nbsp;',array('class'=>'receipt text-center title','style'=>'margin-bottom:10px'));
						...
						$CI->make->sDiv(array('class'=>'modal-content','style'=>'width: 70%;margin: 0 auto;'));
							...
							$CI->make->hidden('ref_no','');
								...
								$CI->make->sDivCol(12,'left',0,array('style'=>''));
									...
									$CI->make->eDiv();
								$CI->make->eDivCol();
								// $CI->make->sDivCol(12,'left',0,array('style'=>'','class'=>'void-pop'));
								// 	$CI->make->sDiv(array('class'=>'form-group paddingsides'));
								// 	$CI->make->button(fa('fa fa-fw fa-ban fa-lg fa-fw').' Void',array('id'=>'void-btn','ref'=>'','class'=>'btn'),'danger');
								// 	$CI->make->eDiv();
								// $CI->make->eDivCol();
								$CI->make->sDivCol(12,'left',0,array('style'=>'','class'=>'cancel-pop'));
									$CI->make->sDiv(array('class'=>'form-group paddingsides'));
									$CI->make->button(fa('fa fa-fw fa-ban fa-lg fa-fw').' Void',array('id'=>'cancel-reserve-reason-btn','ref'=>'','class'=>'btn'),'danger');
									$CI->make->eDiv();
								$CI->make->eDivCol();
							$CI->make->eDiv();
							$CI->make->sDiv(array('class'=>'modal-footer','style'=>'border-top:0!important;'));
					...
					$CI->make->sDiv(array('class'=>'modal-dialog','role'=>'document'));
						$CI->make->sDiv(array('class'=>'modal-content','style'=>'width: 100%;margin: 0 auto;'));
							...
							$CI->make->sDivRow();
					            ...
					            $CI->make->eDivCol();
								$CI->make->sDivCol(9,'left',0,array("style"=>'margin-bottom:10px;'));
									$CI->make->textarea('','other-reason-txt');
									// $CI->make->input('','credit_amount',null,null,array('class'=>'count-inputs rOkay','ro-msg'=>'credit note must not be empty.'));
					            $CI->make->eDivCol();
					            $CI->make->sDivCol(12,'right',0,array("style"=>'margin-bottom:10px'));
					            $CI->make->button(' Cancel',array('data-dismiss'=>'modal','style'=>'margin-right:10px'));
								$CI->make->button(' Submit',array('id'=>'save-reserve-reason-btn', 'class'=>'',"style"=>'color:#fff;background-color:#008d4c!important'));
								$CI->make->eDivCol();
					            	// $CI->make->input('Credit Note No','credit_note_no');
					            	// $CI->make->textarea('Type Reason','other-reason-txt');
								// $buttons = array(
								// 	"Wrong Items Ordered",
								// 	"No Show Pick up",
								// 	"No Show Delivery",
...
// printer new setup
function printerSetupPage($det=null){
	// echo print_r($det['kitchen_printer']);die();
	$CI =& get_instance();
	$user = $CI->session->userdata('user');
				...
				$CI->make->sDivCol(12);
					$CI->make->sDiv(array('class'=>'cpanel-center','style'=>'min-height:420px;'));
							$CI->make->sForm("",array('id'=>'printer-setup-form'));
								$CI->make->printerSetupDrop('KITCHEN PRINTER','kitchen_printer',$det['kitchen_printer'],null,array('class'=>''));
								$CI->make->printerSetupDrop('BEVERAGE PRINTER','beverage_printer',$det['beverage_printer'],null,array('class'=>''));
								$CI->make->printerSetupDrop('EXTRA PRINTER','extra_printer',$det['extra_printer'],null,array('class'=>''));
...
function printerOptionPage($printers=null,$message=""){
	$CI =& get_instance();
	$user = $CI->session->userdata('user');
		$CI->make->sDiv(array('id'=>'cashier-panel','class'=>''));
			$CI->make->sDivRow();
				$CI->make->sDivCol(12);
					$CI->make->H(3,'<i class="fa fa-warning"></i>'.$message,array('id'=>'trans-header','class'=>'receipt text-center text-uppercase','style'=>'color:red;font-size:20px;'));
				$CI->make->eDivCol();
				$CI->make->sDivCol(12);
					// $CI->make->sDivCol(12);
					// 	$CI->make->H(4,'Please select a printer where you want to print the order slip.',array('id'=>'trans-header','class'=>'receipt text-center text-uppercase','style'=>'color:black;font-size:15px;margin-top:40px;'));
					// $CI->make->eDivCol();
				$CI->make->eDivCol();
				$CI->make->sDivCol(12);
					$CI->make->sDiv(array('class'=>'cpanel-center','style'=>'min-height:320px;margin-top:50px;'));

						$CI->make->sForm("",array('id'=>'printer-setup-form'));

							foreach($printers as $k => $v){
								$CI->make->printerSetupDrop(strtoupper($v->printer_name).' PRINTER','printer['.$v->id.']',$v->print_on,null,array('class'=>'printerss','ref'=>$v->id));
							}
							...
							// $CI->make->button(fa('fa-check fa-lg fa-fw').' Submit',array('id'=>'print-submit-btn','class'=>'btn-block cpanel-btn-green'));
							// $CI->make->button(fa('fa-reply fa-lg fa-fw').' Go Back',array('id'=>'back-btn','class'=>'btn-block cpanel-btn-red'));
							// $CI->make->sDiv(array('id'=>'','class'=>'','style'=>'margin-top:40px;'));
							// 	$CI->make->button(fa('fa-print fa-lg fa-fw').' BILLING',array('id'=>'back-btn','class'=>'btn-block cpanel-btn-green'));
							// $CI->make->eDiv();
							// $CI->make->sDiv(array('id'=>'','class'=>'','style'=>'margin-top:40px;'));
							// 	$CI->make->button(fa('fa-print fa-lg fa-fw').' KITCHEN',array('id'=>'print-submit-btn','class'=>'btn-block cpanel-btn-green'));
							// $CI->make->eDiv();
							// $CI->make->sDiv(array('id'=>'','class'=>'','style'=>'margin-top:40px;'));
							// 	$CI->make->button(fa('fa-print fa-lg fa-fw').' BEVERAGE',array('id'=>'back-btn','class'=>'btn-block cpanel-btn-green'));
							// $CI->make->eDiv();
						$CI->make->eForm();
					$CI->make->eDiv();
				$CI->make->eDivCol();
...
function makeBrandform($brands=array(),$default=0){
	$CI =& get_instance();
	// echo "<pre>",print_r($data),"</pre>";die();
		$CI->make->sDivRow(array('style'=>'margin:10px;'));
	// $CI->make->sForm("dine/menu/subcategories_form_db",array('id'=>'subcategories_form'));
		$CI->make->sForm("",array('id'=>'brand-form'));
			$CI->make->hidden('hid-brand',$default,array());
		$CI->make->eForm();
			foreach($brands as $val){
			// $CI->make->sDivCol(12,"",0,array('class'=>''));
				if($default == $val->id){
					$CI->make->sDivCol(4,"",0);
						// $CI->make->span("<strong><font size='6'>SELECT BRAND</font></strong><br><br>");
						$CI->make->button($val->brand_name,array('id'=>'print-brand-btn-'+$val->id,'class'=>'brand-btns btn-block','style'=>'margin-bottom:10px;','brand'=>$val->id),'danger');
					$CI->make->eDivCol();
				}else{
					$CI->make->sDivCol(4,"",0);
						// $CI->make->span("<strong><font size='6'>SELECT BRAND</font></strong><br><br>");
						$CI->make->button($val->brand_name,array('id'=>'print-brand-btn-'+$val->id,'class'=>'brand-btns btn-block','style'=>'margin-bottom:10px;','brand'=>$val->id),'success');
					$CI->make->eDivCol();
				}


				// $CI->make->sDivCol(3,"",0);
				// 	$CI->make->button('MAX',array('id'=>'print-brand-btn','class'=>'brand-btns btn-block cpanel-btn-green'),'success');
				// // $CI->make->eDiv();	
				// $CI->make->eDivCol();	
				// $CI->make->sDivCol(3,"",0);
				// 	$CI->make->button('PANCAKE',array('id'=>'print-brand-btn','class'=>'brand-btns btn-block cpanel-btn-green'),'success');
				// // $CI->make->eDiv();	
				// $CI->make->eDivCol();
			}
...
function tableCombine($tables=array(),$tbl_id=null){
	$CI =& get_instance();
	$CI->make->sDiv(array('id'=>'cashier-panel','style'=>'margin-top:10px;','class'=>'div-no-spaces'));
		$CI->make->hidden('to-table',null);
		$CI->make->sDivRow();
