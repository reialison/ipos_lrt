	...
	$user = $CI->session->userdata('user');
		$CI->make->sDiv(array('id'=>'cashier-panel','class'=>'media-cashier-panel'));
			$CI->make->sDivRow(array('class'=>'cpanel-top'));
				$CI->make->sDivCol(7,'left',0,array('class'=>'cpanel-left media-cpanel-left-cashier','style'=>'margin:0px;height:535px;'));
					...
					$CI->make->eDivRow();
					$CI->make->sDiv(array('class'=>'cpanel-center media-cpanel-center-cashier ','style'=>'margin-right:4px;margin-left:4px;margin-top:1px;height:460px;'));
						...
						$CI->make->sDiv(array('id'=>'prev-next-div','style'=>'margin-top:1px;height:40px;','class'=>'orders-div media-prev-next-div'));
							$CI->make->sDivRow(array('class'=>'center-btns'));
								$CI->make->sDivCol(6);
									$CI->make->sDivRow(array('id'=>'transtext-div','style'=>'height:40px;background-color:green;margin-right:0px;margin-left:0px;width:290px'));
								...
								$CI->make->eDivCol();
								$CI->make->sDivCol(3);
									$CI->make->button(fa('fa-angle-left fa-fw fa-2x').'PREVIOUS',array('class'=>'btn-block cpanel-btn-media-gray','id'=>'pr-btn','style'=>'height:40px;width:130px'));
									// $CI->make->button(fa('fa-refresh fa-2x fa-fw'),array('id'=>'refresh-btn','class'=>'btn-block no-raduis cpanel-btn-orange double'));
								$CI->make->eDivCol();
								$CI->make->sDivCol(3);
									$CI->make->button('NEXT'.fa('fa-angle-right fa-fw fa-2x'),array('class'=>'btn-block cpanel-btn-media-blue','id'=>'nxt-btn','style'=>'height:40px;width:130px'));
									// $CI->make->button(fa('fa-refresh fa-2x fa-fw'),array('id'=>'refresh-btn','class'=>'btn-block no-raduis cpanel-btn-orange double'));
								$CI->make->eDivCol();
							$CI->make->eDivRow();
						$CI->make->eDiv();
					...
					$CI->make->eDiv();
				$CI->make->eDivCol();
				$CI->make->sDivCol(2,'center',0,array('class'=>'cpanel-left media-cpanel-left-cashier media-cpanel-left-width-cashier','style'=>'margin:0px;height:535px;'));
					...
					$CI->make->sDivRow(array('id'=>'mid-div','class'=>'media-cpanel-mid-div-cashier','style'=>'height:395px; margin-top:5px;'));

						if(!ORDERING_STATION){
							if(MALL != 'megaworld'){
								$CI->make->button(lng('cp_btn_cust_deposit'),array('id'=>'cust-bank-btn','class'=>'btn-block cpanel-btn-green media-btn-height'));
							}
							// $CI->make->button(lng('cp_btn_gift_cards'),array('id'=>'gift-card-btn','class'=>'btn-block cpanel-btn-green'));
							$CI->make->button(lng('cp_btn_gift_cards'),array('id'=>'gift-card-btn','class'=>'btn-block cpanel-btn-green media-btn-height media-mid-div-margin'));
							// $CI->make->button(lng('cp_btn_loyalty_cards'),array('id'=>'loyalty-card-btn','class'=>'btn-block cpanel-btn-green'));
							$CI->make->button(lng('cp_btn_reservation'),array('id'=>'reserve-btn','class'=>'btn-block cpanel-btn-green media-btn-height media-mid-div-margin'));
					...
					$CI->make->sDivRow(array('style'=>'margin-top:5px;'));
						// $CI->make->sDivCol(11,'left',0);
							$CI->make->button(lng('cp_btn_select_brand'),array('id'=>'selbrand-btn','class'=>'btn-block cpanel-btn-teal','style'=>'height:60px;width:130px'));
						// $CI->make->eDivCol();
					$CI->make->eDivRow();
				$CI->make->eDivCol();
				$CI->make->sDivCol(3,'center',0,array('class'=>'cpanel-left media-cpanel-left-cashier media-right-panel-cashier','style'=>'height:535px;'));
					...
					$CI->make->sDivRow(array('id'=>'transaction-div','class'=>'media-width-trans-type','style'=>'height:345px;margin-top:5px;'));
					...
					$CI->make->sDivRow(array('id'=>'nextprev-div','style'=>'height:50px'));
					// $CI->make->sDivRow();
						$CI->make->sDivCol(5,'left',0,array('class'=>''));
							$CI->make->button(fa('fa-chevron-left fa-2x fa-fw media-cashier-prev') .strtoupper('BACK'),array('id'=>'tprev-btn','class'=>'pn-btn btn-block cpanel-btn-kahel','style'=>'width:130px;height:60px'));
						$CI->make->eDivCol();
						$CI->make->sDivCol(5,'left',0,array('class'=>'media-cashier-navi-btn'));
							$CI->make->button(fa('fa-chevron-right fa-2x fa-fw media-cashier-next') .'<span class="media-cashier-next-text">NEXT</span>',array('id'=>'tnext-btn','class'=>'pn-btn btn-block cpanel-btn-dilaw','style'=>'width:130px;height:60px'));
						$CI->make->eDivCol();
					$CI->make->eDivRow();
					$CI->make->sDivRow(array('style'=>''));
						$CI->make->sDivCol(11,'left',0);
							$CI->make->inputsearch(null,'search-trans',null,'SEARCH',array('style'=>'height:60px;width:220px;'),fa('fa fa-search'));
						$CI->make->eDivCol();
					$CI->make->eDivRow();
				$CI->make->eDivCol();
			$CI->make->eDivRow();
				...
				if(!ORDERING_STATION){
					...
					$CI->make->sDivCol(4,'right','',array('class'=>''));
						$CI->make->sDivCol(4,'left','',array('class'=>''));
							...
							$CI->make->button(lng('cp_btn_quick_edit'),array('id'=>'quick-edit-btn','class'=>'btn-block cpanel-btn-brown-orange double','style'=>'width:95px;margin-bottom:5px'));
						$CI->make->eDivCol();
						$CI->make->sDivCol(4,'left','',array('class'=>''));
							$CI->make->button(fa('fa-print fa-2x fa-fw').'<br> '.lng('cp_btn_printer_setup'),array('id'=>'printer-setup-btn','class'=>'btn-block cpanel-btn-brown-orange double','style'=>'width:95px;margin-bottom:5px'));
						$CI->make->eDivCol();
						$CI->make->sDivCol(4,'left','',array('class'=>''));
							$CI->make->button(fa('fa-clock-o fa-2x fa-fw').'<br> CLOCK IN/OUT',array('id'=>'time-clock-btn','class'=>'btn-block cpanel-btn-brown-orange double','style'=>'width:95px;margin-bottom:5px'));
						$CI->make->eDivCol();						
					$CI->make->eDivCol();

					$CI->make->sDivCol(4,'left','',array('style'=>''));
						$CI->make->sDivCol(4,'left','',array('class'=>''));
							$CI->make->button('OPEN <br>DRAWER',array('id'=>'open-drawer-btn','class'=>'btn-block cpanel-btn-brown-orange double','style'=>'width:95px;margin-bottom:5px'));
						$CI->make->eDivCol();
						$CI->make->sDivCol(4,'left','',array('class'=>''));
							$CI->make->button('MANAGER <br> FUNCTION ',array('id'=>'manager-btn','class'=>'btn-block cpanel-btn-brown-orange double','style'=>'width:95px;margin-bottom:5px;margin-right:25px;'));
						$CI->make->eDivCol();
						$CI->make->sDivCol(4,'left','',array('class'=>''));
							$CI->make->button('BACK OFFICE <br>FUNCTION',array('id'=>'back-office-btn','class'=>'btn-block cpanel-btn-brown-orange double','style'=>'width:95px;margin-bottom:5px'));
						$CI->make->eDivCol();
					...
					$CI->make->sDivCol(4,'left','',array('style'=>''));
						$CI->make->sDivCol(4,'left','',array('class'=>''));
							$CI->make->button('CUSTOMER INQ',array('id'=>'cust-inq-btn','class'=>'btn-block cpanel-btn-brown-orange double','style'=>'width:95px;margin-bottom:5px'));
						$CI->make->eDivCol();
						$CI->make->sDivCol(4,'left','',array('class'=>''));
							$CI->make->button('SYNC ITEMS',array('id'=>'sync-items-btn','class'=>'btn-block cpanel-btn-brown-orange double','style'=>'width:95px;margin-bottom:5px'));
						$CI->make->eDivCol();	
						$CI->make->sDivCol(4,'left','',array('class'=>''));
							$CI->make->button('SYNC DATA',array('id'=>'sync-data-btn','class'=>'btn-block cpanel-btn-brown-orange double','style'=>'width:95px;margin-bottom:5px'));
						$CI->make->eDivCol();
					$CI->make->eDivCol();
		...
		$CI->make->sDiv(array('id'=>'counter'));
			$CI->make->sDivRow();
				...
				$CI->make->sDivCol(4,'left',0,array('class'=>'media-center-div-panel'));
					...
					$CI->make->sDiv(array('class'=>'counter-right media-counter-right','style'=>'height:672px;overflow:hidden;background-color:#255F93'));
						...
						$CI->make->sDiv(array('class'=>'category-div loads-div','style'=>''));
							...
							$CI->make->eDiv();
							if($type== 'dinein'){
									$CI->make->sDiv(array('style'=>'margin-bottom:35px'));
							...
							$CI->make->sDiv(array('class'=>'category-lists media-width-category','style'=>'height:435px;overflow:hidden;'));
						 	 	// $CI->make->hidden('mods-mandatory',"0",array("class"=>"mods-mandatory"));
						 	 	// $CI->make->hidden('mod-group-name',null,array("class"=>"mod-group-name"));
							$CI->make->eDiv();
						$CI->make->eDiv();
						...
						$CI->make->sDiv(array('class'=>'mods-div loads-div media-width-mods','style'=>'display:none'));
							...
							$CI->make->sDiv(array('class'=>'mods-lists','style'=>'height:490px;overflow:hidden;'));
						 	 	$CI->make->hidden('mods-mandatory',"0",array("class"=>"mods-mandatory"));
						 	 	$CI->make->hidden('mod-group-name',null,array("class"=>"mod-group-name"));
							$CI->make->eDiv();
						$CI->make->eDiv();
						...
						$CI->make->sDiv(array('class'=>'subcategory-div loads-div','style'=>'display:none'));
							...
							$CI->make->sDiv(array('class'=>'subcategory-lists media-subcategory-lists','style'=>'height:475px;overflow:hidden;'));
							$CI->make->eDiv();
						$CI->make->eDiv();
						...
						$CI->make->sDiv(array('class'=>'counter-center-btns center-div list-div',"style"=>"margin-top: 1px;"));
							...
							if($update == ''){
								$CI->make->sDivCol(2,"",0,array('class'=>'center-btn-div search-btn-panel'));
									$CI->make->button(fa('fa-search fa-lg fa-fw').'SEARCH',array('id'=>'display-search-btn','class'=>'btn-block counter-btn-blue double','style'=>'height:60px;background-color:#A6A6A6!important;width:80px'));
								$CI->make->eDivCol();
							}
								

								$CI->make->sDivCol(3,"",0,array('style'=>'display:none','class'=>'search-display '));
									$CI->make->button(fa('fa-search fa-lg fa-fw').'CANCEL',array('id'=>'cancel-search-btn','class'=>'btn-block counter-btn-blue double','style'=>'height:60px;background-color:#A6A6A6!important;width:130px'));
								$CI->make->eDivCol();

								$CI->make->sDivCol(7,'left',0,array('style'=>'display:none','class'=>'search-display search-display-input'));
								...
								$CI->make->button('CANCEL',array('id'=>'cancel-btn','class'=>'btn-block counter-btn-red double','style'=>'height:60px;background-color:#FF0000!important;font-size: 20px;width:130px'));
								$CI->make->eDivCol();
								if(!ORDERING_STATION && $update == ''){
									$CI->make->sDivCol(6,"",0,array('class'=>'center-btn-div settle-btn-panel'));
										$CI->make->button(' SETTLE',array('id'=>'settle-btn','class'=>'btn-block counter-btn-teal double','style'=>'height:60px!important; background-color:#767171!important;font-size: 30px;'));
									$CI->make->eDivCol();
								}
						...
						$CI->make->sDiv(array('class'=>'number-center-btns center-div list-div',"style"=>"margin-top: 5px;"));
							$CI->make->sDivRow();
								$CI->make->sDivCol(2);
									$CI->make->button('1',array('id'=>'display-search-btn','class'=>'btn-block counter-btn-blue double num-qty','style'=>'height:60px;background-color:#404040!important;width:63px;font-size:18px','num'=>1));
									$CI->make->button('7',array('id'=>'display-search-btn','class'=>'btn-block counter-btn-blue double num-qty','style'=>'height:60px;background-color:#404040!important;margin-top:3px;width:63px;font-size:18px','num'=>7));
								$CI->make->eDivCol();
								$CI->make->sDivCol(2);
									$CI->make->button('2',array('id'=>'display-search-btn','class'=>'btn-block counter-btn-blue doubl num-qty','style'=>'height:60px;background-color:#404040!important;width:63px;font-size:18px','num'=>2));
									$CI->make->button('8',array('id'=>'display-search-btn','class'=>'btn-block counter-btn-blue double num-qty','style'=>'height:60px;background-color:#404040!important;margin-top:3px;width:63px;font-size:18px','num'=>8));
								$CI->make->eDivCol();
								$CI->make->sDivCol(2);
									$CI->make->button('3',array('id'=>'display-search-btn','class'=>'btn-block counter-btn-blue double num-qty','style'=>'height:60px;background-color:#404040!important;width:63px;font-size:18px','num'=>3));
									$CI->make->button('9',array('id'=>'display-search-btn','class'=>'btn-block counter-btn-blue double num-qty','style'=>'height:60px;background-color:#404040!important;margin-top:3px;width:63px;font-size:18px','num'=>9));
								$CI->make->eDivCol();
								$CI->make->sDivCol(2);
									$CI->make->button('4',array('id'=>'display-search-btn','class'=>'btn-block counter-btn-blue double num-qty','style'=>'height:60px;background-color:#404040!important;width:63px;font-size:18px','num'=>4));
									$CI->make->button('0',array('id'=>'display-search-btn','class'=>'btn-block counter-btn-blue double num-qty','style'=>'height:60px;background-color:#404040!important;margin-top:3px;width:63px;font-size:18px','num'=>'0'));
								$CI->make->eDivCol();
								$CI->make->sDivCol(2);
									$CI->make->button('5',array('id'=>'display-search-btn','class'=>'btn-block counter-btn-blue double num-qty','style'=>'height:60px;background-color:#404040!important;width:63px;font-size:18px','num'=>5));
									$CI->make->button('.',array('id'=>'display-search-btn','class'=>'btn-block counter-btn-blue double num-qty','style'=>'height:60px;background-color:#404040!important;margin-top:3px;width:63px;font-size:18px','num'=>'.'));
								$CI->make->eDivCol();
								$CI->make->sDivCol(2);
									$CI->make->button('6',array('id'=>'display-search-btn','class'=>'btn-block counter-btn-blue double num-qty','style'=>'height:60px;background-color:#404040!important;width:63px;font-size:18px','num'=>6));
									$CI->make->button('CLEAR',array('id'=>'clear-qty-btn','class'=>'btn-block counter-btn-blue double','style'=>'height:60px;background-color:#C00600!important;margin-top:3px;width:63px;font-size:18px'));
								$CI->make->eDivCol();
				...
				$CI->make->sDivCol(2,'left',0,array('class'=>'counter-left media-ctr-left-background'));
					...
					$CI->make->button('Select<br> MGI&nbsp;Brand',array('id'=>'selbrand-btn','class'=>'btn-block counter-btn-teal','style'=>'height:60px;border:solid #BFBFBF 3px;background-color:#C55B2C!important; width:130px; margin-bottom:-3px'));
					$CI->make->sDivCol(12,'left',0);
						$CI->make->button('TAKE OUT',array('id'=>'take-all-btn','class'=>'btn-block counter-btn-green double','style'=>'height:60px;border:solid #BFBFBF 3px;background-color:#70AD47!important;width:130px;margin-bottom:-3px;margin-bottom:-3px;'));
						// if($type== 'reservation'){
						...
						// }else{
						$CI->make->button('SEND TO KITCHEN',array('id'=>'submit-btn','class'=>'btn-block counter-btn-red double','style'=>'height:60px!important;border:solid #BFBFBF 3px;background-color:#70AD47!important;width:130px;margin-bottom:-3px;'));
						// }
						// if(SERVER_NO_SETUP && isset($typeCN[0]['type']) && $typeCN[0]['type'] == 'counter' || SERVER_NO_SETUP && isset($typeCN[0]['type']) && $typeCN[0]['type'] == 'takeout'){
							$CI->make->button('SERVE NO.',array('id'=>'serve-no-btn','class'=>'btn-block counter-btn-red double','style'=>'height:60px;border:solid #BFBFBF 3px;background-color:#70AD47!important;width:130px;margin-bottom:-3px;'));
						// }else{
						...
						// }
						$CI->make->button('ADD REMARKS',array('id'=>'remarks-btn','class'=>'btn-block counter-btn-red double','style'=>'height:60px;border:solid #BFBFBF 3px;background-color:#70AD47!important;width:130px;margin-bottom:-3px;'));
						$CI->make->button('REMOVE',array('id'=>'remove-btn','class'=>'btn-block counter-btn-red double '.$loaded,'style'=>'height:60px;border:solid #BFBFBF 3px;background-color:#70AD47!important;width:130px;margin-bottom:-3px;'));
						
					// $CI->make->eDivCol();
					// $CI->make->sDivCol(6,'left',0);
						$CI->make->button('FREE',array('id'=>'free-btn','class'=>'btn-block counter-btn-red double','style'=>'height:60px;border:solid #BFBFBF 3px;background-color:#70AD47!important;width:130px;margin-bottom:-3px;'));
						$CI->make->button('HOLD ALL',array('id'=>'hold-all-btn','class'=>'btn-block counter-btn-red double','style'=>'height:60px;border:solid #BFBFBF 3px;background-color:#70AD47!important;width:130px;margin-bottom:-3px;'));
						$CI->make->button('ADD CHARGES',array('id'=>'charges-btn','class'=>'btn-block counter-btn-red double','style'=>'height:60px;border:solid #BFBFBF 3px;background-color:#70AD47!important;width:130px;margin-bottom:-3px;'));
						if(ORDERING_STATION){
							$CI->make->button('ADD DISCOUNT',array('id'=>'no-discount-btn','class'=>'btn-block counter-btn-red double','style'=>'height:60px;border:solid #BFBFBF 3px;background-color:#70AD47!important;width:130px;margin-bottom:-3px;'));
						}else{
							$CI->make->button('ADD DISCOUNT',array('id'=>'add-discount-choose-btn','class'=>'btn-block counter-btn-red double','style'=>'height:60px;border:solid #BFBFBF 3px;background-color:#70AD47!important;width:130px;margin-bottom:-3px;'));						
						}

						if($type == 'reservation'){
							$CI->make->button('SUBMIT RESERVATION',array('id'=>'rhold-all-btn','class'=>'btn-block counter-btn-red double','style'=>'height:60px!important;border:solid #BFBFBF 3px;background-color:#70AD47!important;width:130px;margin-bottom:-3px;'));
						}
...
function settlePage($ord=null,$det=null,$discs=null,$totals=null,$charges=null,$trans_retake=false,$payment_types=null,$gc_types=null,$payment_group=null){
	$CI =& get_instance();
		...
		$CI->make->sDiv(array('class'=>'media-settle-panel','id'=>'settle','retrack'=>$ret,'sales'=>$ord['sales_id'],'type'=>$ord['type'],'balance'=>num($ord['balance'])));
			...
			$CI->make->sDivRow();
				$CI->make->sDiv(array('class'=>'pay-search','style'=>''));
					$CI->make->input(null,'search-payment',null,null,array(),fa('fa fa-search')." Search Payment");
				$CI->make->eDiv();

				$CI->make->sDivCol(12,'left',0,array('class'=>''));
					$CI->make->sDivRow(array('class'=>'settle-right','style'=>'height:100px;overflow:auto;padding:0px'));					
