...
// echo $text[1];
						...
						if(MANANGS){
							...
							if($texts == 'dinein'){
								$CI->make->button(strtoupper($text[1]),array('id'=>$texts.'-btn','class'=>'new-order-btns btn-block cpanel-btn-silver'));
								...
								$CI->make->button(strtoupper($text[1]),array('id'=>$texts.'-btn','class'=>'new-order-btns btn-block cpanel-btn-pink'));
		...
		$CI->make->sDiv(array('id'=>'counter'));
			$CI->make->sDivRow();
				...
				$CI->make->sDivCol(1,'left',0,array('class'=>'counter-left'));
					...
					// $CI->make->button(fa('fa-magnet fa-lg fa-fw').'<br>Take Out',array('id'=>'take-all-btn','class'=>'btn-block counter-btn-red double'));
					if(ORDERING_STATION){
						if($type == 'retail'){
				...
				#CENTER
				$CI->make->sDivCol(5);
					$CI->make->sDiv(array('class'=>'center-div counter-center list-div',"style"=>'height:610px;'));
						$CI->make->sDivRow();
				...
				$CI->make->sDivCol(5,'left',0);
					...
					$CI->make->sDiv(array('class'=>'counter-right','style'=>'height:671px;overflow:hidden;'));
						#MENU
...
function settlePage($ord=null,$det=null,$discs=null,$totals=null,$charges=null,$trans_retake=false){
	$CI =& get_instance();
		$ret = 0;
		if($trans_retake)
			$ret = 1;
		$CI->make->sDiv(array('id'=>'settle','retrack'=>$ret,'sales'=>$ord['sales_id'],'type'=>$ord['type'],'balance'=>num($ord['balance'])));
			$CI->make->sDivRow();
				...
				$CI->make->sDivCol(7,'left',0,array('class'=>'settle-right'));
					...
					$CI->make->sBox('default',array('class'=>'loads-div select-payment-div box-solid bg-dark-green'));
						...
						$CI->make->sBoxBody(array('class'=>'bg-dark-green'));
								...
								$buttons = array("cash"	=> "CASH",
												 ...
												 // "cust-deposits"	=> fa('fa-inbox fa-lg fa-fw')."<br> Deposits",
					...
					$CI->make->sBox('default',array('class'=>'loads-div after-payment-div box-solid'));
						...
						$CI->make->sBoxBody(array('class'=>'bg-dark-green'));
							...
							$CI->make->sDivRow();
								$CI->make->sDivCol(4,'left');
									$CI->make->button(fa('fa-plus fa-lg fa-fw').' Additional Payment',array('id'=>'add-payment-btn','class'=>'btn-block settle-btn-teal double'));
								$CI->make->eDivCol();
								$CI->make->sDivCol(4,'left');
					...
					$CI->make->sBox('default',array('class'=>'loads-div online-deal-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' Online Deal PAYMENT');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div cust-deposits-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle('Customer Deposits PAYMENT');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
								...
								$CI->make->eDivCol();
								$CI->make->sDivCol(6);
									$CI->make->input('Customer','cust-deposits-cust-name','','',array('readOnly'=>'readOnly','maxlength'=>'10',
										'style'=>
											'width:100%;
											height:100%;
											font-size:24px;
									...
									$CI->make->input('Customer Deposit Amount','cust-deposits-amt','','',array('readOnly'=>'readOnly','maxlength'=>'10',
										'style'=>
											'width:100%;
											height:100%;
											font-size:34px;
					...
					$CI->make->sBox('default',array('class'=>'loads-div loyalty-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' LOYALTY CARD PAYMENT');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div foodpanda-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' PANDA PAYMENT');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div check-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' CHECK PAYMENT');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div gcash-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' GCASH PAYMENT');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->eBox();
					//PAYMAYA
					$CI->make->sBox('default',array('class'=>'loads-div paymaya-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' PAYMAYA PAYMENT');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
									$CI->make->input('Reference #','paymaya-num','','',array('maxlength'=>'100',
										'style'=>
											'width:100%;
											height:100%;
											font-size:34px;
					...
					$CI->make->sBox('default',array('class'=>'loads-div wechat-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' WeChat PAYMENT');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div alipay-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' ALIPAY PAYMENT');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div egift-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' E-GIFT PAYMENT');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div paypal-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' PAYPAL PAYMENT');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div grabfood-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' GRABFOOD PAYMENT');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div lalafood-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' LALAFOOD PAYMENT');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div grabmart-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' GRABMART PAYMENT');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div pickaroo-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' PICKAROO PAYMENT');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div mofopaymongo-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' MOFO PAYMONGO PAYMENT');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div grabpaybdo-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' GRABPAY BDO PAYMENT');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div pmayaewallet-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' PAYMAYA E-WALLET PAYMENT');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div pmayacredcard-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' PAYMAYA CREDIT CARD PAYMENT');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div tmgbtransfer-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' TMG BANK TRANSFER PAYMENT');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div fppickupcash-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' FP PICKUP CASH PAYMENT');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div fppickonlne-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' FP PICKUP ONLINE PAYMENT');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div gfselfpickup-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' GF SELF PICKUP PAYMENT');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div hlmogobt-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' HOTLINE MOGO BANK TRANSFER');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div hlmogocash-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' HOTLINE MOGO CASH');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div hlmogogcash-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' HOTLINE MOGO GCASH');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div mofopmaya-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' MOFO PAYMAYA PAYMENT');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div fasttrack-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' FAST TRACK PAYMENT');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div mofocash-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' MOFO CASH PAYMENT');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div dineinpmayacrd-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' DINE IN PAYMAYA CARD');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div dineoutpmayacrd-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' DINE OUT PAYMAYA CARD');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div smmallonline-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' SM MALLS ONLINE');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div mofopmayadinein-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' MOFO PAYMAYA DINEIN');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
					...
					$CI->make->sBox('default',array('class'=>'loads-div mofocashdinein-payment-div box-solid','style'=>'display:none;'));
						$CI->make->sBoxHead(array('class'=>'bg-green'));
							$CI->make->boxTitle(' MOFO CASH DINEIN');
						$CI->make->eBoxHead();
						$CI->make->sBoxBody(array('style'=>'background-color:#F4EDE0;'));
							$CI->make->sDivRow(array('style'=>'margin:auto 0;'));
								$CI->make->sDivCol(6);
