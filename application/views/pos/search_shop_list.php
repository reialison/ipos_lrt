<body>
                      ...
                      if(empty($items)){ ?>
                        ...
                        <div class="col-md-11 col-md-offset-1">
                          ...
                          foreach($items as $item){ 
                            ...
                            //   if($item->menu_short_desc == $mval->menu_short_desc){
                                $div_ctr = count($items);
                                if($div_ctr = 1){
                                  $ctr = 12;
                                  $cm = 11;
                                ...
                                <div class="modal fade" id="basic" ref="<?=$item_id?>" tabindex="-1" role="basic" aria-hidden="true">
                                         ...
                                         <?php } ?>
                                           <div class="modal-body col-md-12">
                                            ...
                                            <div class="col-xs-2 col-md-2">
                                              <!-- <ul> -->
                                                <!-- <li> -->
                                                  <input type="number" name="qty" class="qt" min="1" value="1" />                             
                                                <!-- </li> -->
                                              <!-- </ul> -->
                                            </div>
                                            <div class="col-md-1">
                                ...
                                <div class="col-md-<?=$ctr?> col-md-offset-<?=$cmo?>">
                                  <?php                                                                              
                                  ...
                                  <div class="product-info" ref="<?=$item_id?>">
                                    <div class="mt-element-ribbon ">
                                      <div class="ribbon ribbon-border-hor ribbon-clip ribbon-color-danger uppercase product-price">
                                        <div class="ribbon-sub ribbon-clip "></div><?=$srp_label?></div>
                                     </div>
                                    ...
                                    if (!empty($modifiers)) { ?>
                                      <div class="marginize_bottom">
                                        <a href="#basic" data-toggle="modal" ref="<?=$item_id?>" imref="<?=$item->img_id; ?>" aref="01" class="shop-btn"> <img src="<?=base_url().'img/basket.png'?>" class="basket_img basket"> Buy &nbsp;&nbsp;</a>
                                      </div>
                                     <?php
                                    }else{ ?>
                                      <div class="marginize_bottom">
                                        <a href="#nomodi<?=$item_id?>" data-toggle="modal" ref="<?=$item_id?>" imref="<?=$item->img_id; ?>" aref="02"  class="shop-btn"> <img src="<?=base_url().'img/basket.png'?>" class="basket_img basket"> Buy &nbsp;&nbsp;</a>
                                      </div>
                                      <?php // echo 'hehe';
                                    } ?>
                                  </div>
  ...
  <div data-role="main" id="left-panel" class="ui-content ui-panel ui-panel-position-left ui-panel-display-reveal ui-body-inherit ui-panel-animate ui-panel-open" data-position="left">
    <nav class="main-nav">
      <ul style="overflow-x: auto!important;max-height: 950px;">
        <?php
