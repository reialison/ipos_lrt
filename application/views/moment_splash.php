<?php
    ...
    ?>
        <body class='skin-red'  style="background-color: #fff!important;"
                    ...
                    <div class="navbar-right">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="">
                                ...
                                <a href="<?=base_url().'support/info'?>" class="dropdown-toggle"  data-close-others="true">
        ...
        <div class=" cashier-wrapper row-offcanvas row-offcanvas-left" style="">
